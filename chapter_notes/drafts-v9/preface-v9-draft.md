...
There have long been two roads through a first course in linear algebra. The old road runs on determinants. You compute your way through a semester, and the truth never quite arrives. The determinant people are still out there, computing, and their road is the same road as the rest of the pipeline that carried you through school. When every tool is a computation, every problem gets hammered into a computation-shaped nail.
